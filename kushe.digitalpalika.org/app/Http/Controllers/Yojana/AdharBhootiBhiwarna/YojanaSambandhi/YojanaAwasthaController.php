...
use App\Models\Yojana\AdharBhooti\YojanaSambandhi\YojanaAwastha;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Yajra\DataTables\Facades\DataTables;

class YojanaAwasthaController extends Controller
{
    /**
     ...
     */
    private $class_instance=YojanaAwastha::class;
    private $route_name="yojana-awastha";
    private $view_path="yojana.adharbhooti_bhiwarna.yojana_sambandhi.yojana_awastha";
    private $rules=[
        "code"=>"required",
        "name"=>"required",
        "continuous"=>"required",
