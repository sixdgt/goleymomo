...
use App\Models\Yojana\AdharBhooti\YojanaSambandhi\EkaikoPrakar;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Yajra\DataTables\Facades\DataTables;

class EkaikoPrakarController extends Controller
{
    /**
     ...
     */
    private $class_instance=EkaikoPrakar::class;
    private $route_name="ekaiko-prakar";
    private $view_path="yojana.adharbhooti_bhiwarna.yojana_sambandhi.ekaiko_prakar";
    private $rules=[
        "code"=>"required",
        "name"=>"required",
        "full_name"=>"required",
