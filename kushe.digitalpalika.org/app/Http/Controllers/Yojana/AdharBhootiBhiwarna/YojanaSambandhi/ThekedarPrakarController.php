...
use App\Models\Yojana\AdharBhooti\YojanaSambandhi\ThekedarPrakar;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Yajra\DataTables\Facades\DataTables;

class ThekedarPrakarController extends Controller
{
    /**
     ...
     */
    private $class_instance=ThekedarPrakar::class;
    private $route_name="thekedar-prakar";
    private $view_path="yojana.adharbhooti_bhiwarna.yojana_sambandhi.thekedar_prakar";
    private $rules=[
        "code"=>"required",
        "name"=>"required",
        "full_name"=>"required",
