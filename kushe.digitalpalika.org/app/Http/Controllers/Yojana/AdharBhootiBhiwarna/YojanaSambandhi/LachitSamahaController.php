...
use App\Models\Yojana\AdharBhooti\YojanaSambandhi\LachitSamaha;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Yajra\DataTables\Facades\DataTables;

class LachitSamahaController extends Controller
{
    private $class_instance=LachitSamaha::class;
    private $route_name="lachit-samaha";
    private $view_path="yojana.adharbhooti_bhiwarna.yojana_sambandhi.lachit_samaha";
    private $rules=[
        "code"=>"required",
        "name"=>"required",
        "full_name"=>"required",
