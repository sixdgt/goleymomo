...
use App\Models\Yojana\AdharBhooti\BudgetShrotBawasayathapan\BhootaniMadyam;
use Illuminate\Http\Request;

class BhootaniMadyamController extends SharedController
{
    public $messages;
    ...
    public $title = 'भुक्तानी  माध्यम';
    public $class_instance = BhootaniMadyam::class;
    public $route_name = 'bhootani-madyam';
    public $view_path = 'yojana.shared_view';
    public $table_headers = ['त्र .स', 'कोड','लेखा शीर्षक','पुरा नाम', 'नाम', 'वीवरण', 'स्थिति'];
    public $columns = ['code','account_title' ,'full_name', 'name', 'details', 'situation'=>['name'=>'situation','whileTrue'=>'सक्रिय','whileFalse'=>'निष्कृय']];
    /*
    ...
    public function createForm($data = null,$method='post',$action='store')
    {
        $this->form = [
            ...
            [
                ...
                [
                ['options'=>['key'=>'a','key1'=>'b','key2'=>'c'],'label'=>'लेखा शीर्षक','value'=>(isset($data->account_title)),'name'=>'account_title'],
                    []
                ],
                [
