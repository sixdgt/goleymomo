...
use App\Models\Yojana\AdharBhooti\BudgetShrotBawasayathapan\SahayakLedger;
use Illuminate\Http\Request;

class SahayakLedgerController extends SharedController
{
    public $messages;
    ...
    public $title = 'सहायक लेजर';
    public $class_instance = SahayakLedger::class;
    public $route_name = 'sahayak-ledger';
    public $view_path = 'yojana.shared_view';
    public $table_headers = ['त्र .स', 'कोड', 'पुरा नाम', 'नाम', 'क्रमागत','वीवरण', 'स्थिति'];
    public $columns = ['code', 'full_name', 'name', 'continuous','details', 'situation'=>['name'=>'situation','whileTrue'=>'सक्रिय','whileFalse'=>'निष्कृय']];
    /*
    ...
    public function createForm($data = null,$method='post',$action='store')
    {
        $this->form = [
            ...
            [
                ...
                [
                    ['options'=>['key'=>'a','key1'=>'b','key2'=>'c'],'label'=>'क्रमागत','value'=>(isset($data->continuous)),'name'=>'continuous'],
                    []
                ],
                [
