...
use App\Models\Yojana\AdharBhooti\BudgetShrotBawasayathapan\PrasiKoShrot;
use Illuminate\Http\Request;

class PrasiKoShrotController extends SharedController
{
    public $messages;
    ...
    public $title = 'प्रासीको  स्रोत';
    public $class_instance = PrasiKoShrot::class;
    public $route_name = 'prasi-ko-shrot';
