...
use App\Models\Yojana\AdharBhooti\BudgetShrotBawasayathapan\BudgetUpsepark;
use Illuminate\Http\Request;

class BudgetUpseparkController extends SharedController
{
    public $messages;
    ...
    public $title = 'बजेट उपशीर्षक';
    public $class_instance = BudgetUpsepark::class;
    public $route_name = 'budget-upsepark';
