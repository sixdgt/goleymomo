...
@section('yojana-content')
    ...
    <x-card.card :headers="['title' => $data['title'], 'route' => route($data['route_name'].'.create')]">
        {{-- start table --}}
        <x-table.table :tableHeaders="['त्र .स', 'कोड', 'पुरा नाम', 'नाम', 'प्रतीक','वीवरण', 'स्थिति']">
        </x-table.table>
        {{-- end table --}}
    </x-card.card>
    {{-- end of card --}}
...
@section('custom-script')
    ...
    <x-script.datatable-script :options="[
        ...
        'columns' => ['code', 'full_name', 'name','symbol','details', 'situation'=>['name'=>'situation','whileTrue'=>'सक्रिय','whileFalse'=>'निष्कृय']],
    ]">
        {{-- datatable --}}
