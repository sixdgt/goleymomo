...
@section('yojana-content')
    <div class="card">
        ...
        <form style="width: 100%;" id="add-form-chalani" method="POST" action="{{ route('yojana-kissim.store') }}">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" name="upper_group" id="माथिल्लो समूह"
