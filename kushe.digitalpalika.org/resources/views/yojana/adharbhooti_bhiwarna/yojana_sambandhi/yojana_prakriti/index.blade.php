...
@section('yojana-content')
    {{-- start card --}}
    <x-card.card :headers="['title' => 'योजना प्रकृति ', 'route' => route('yojana-prakriti.create')]">
        {{-- start table --}}
...
@section('custom-script')
    ...
    <x-script.datatable-script :options="[
        'route' => route('yojana-prakriti.index'),
    ...
    {{-- alert --}}
    <x-script.delete-script route="{{ route('yojana-prakriti.destroy', '') }}"></x-script.delete-script>
@endsection
{{-- custom script ends --}}
