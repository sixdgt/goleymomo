    ...
    <section id="chalani-content" class="mt-2">
        <div class="card">
            <div class="card-header">
                <div class="d-flex">
                    <h5 class="me-auto">खार्चाको फाटवारी</h5>
                    <a href="{{ route('kharcha-faatwari-bhiwaran.create') }}" class="btn_palika" id="add-new"><i
        ...
        function getData() {
            $(function() {
                ...
                var table = $('.chalani-data-table').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('kharcha-faatwari-bhiwaran.index') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex'
                        },
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                if (data == 1) {
                                    return '<span class="badge text-success">थप</span>'
                                } else {
                                    return '<span class="badge text-danger">घटाउ</span>'
                                }
                            }
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                if (data == 1) {
                                    return '<span class="badge text-success">सक्रिय</span>'
                                } else {
                                    return '<span class="badge text-danger">निष्कृय </span>'
                                }
                            }
                        },
                        {
        ...
        function del(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "delete",
                        url: "{{ route('kharcha-faatwari-bhiwaran.destroy', '') }}" + "/" + id,
                        data: data,
