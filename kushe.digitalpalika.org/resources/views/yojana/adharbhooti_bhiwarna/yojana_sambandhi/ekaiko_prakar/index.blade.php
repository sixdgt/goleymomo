...
@section('yojana-content')
    {{-- start card --}}
    <x-card.card :headers="['title' => 'इकाईको प्रकार ', 'route' => route('ekaiko-prakar.create')]">
        {{-- start table --}}
...
@section('custom-script')
    ...
    <x-script.datatable-script :options="[
        'route' => route('ekaiko-prakar.index'),
    ...
    {{-- alert --}}
    <x-script.delete-script route="{{ route('ekaiko-prakar.destroy', '') }}"></x-script.delete-script>
@endsection
{{-- custom script ends --}}
