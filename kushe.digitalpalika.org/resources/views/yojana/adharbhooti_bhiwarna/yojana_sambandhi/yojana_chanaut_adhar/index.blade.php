...
@section('yojana-content')
    {{-- start card --}}
    <x-card.card :headers="['title' => ' योजना छनौट आधार ', 'route' => route('yojana-chanaut-adhar.create')]">
        {{-- start table --}}
...
@section('custom-script')
    ...
    <x-script.datatable-script :options="[
        'route' => route('yojana-chanaut-adhar.index'),
    ...
    {{-- alert --}}
    <x-script.delete-script route="{{ route('yojana-chanaut-adhar.destroy', '') }}"></x-script.delete-script>
@endsection
{{-- custom script ends --}}
