...
@section('yojana-content')
    {{-- start card --}}
    <x-card.card :headers="['title' => 'ठेकेदार प्रकार  ', 'route' => route('thekedar-prakar.create')]">
        {{-- start table --}}
...
@section('custom-script')
    ...
    <x-script.datatable-script :options="[
        'route' => route('thekedar-prakar.index'),
    ...
    {{-- alert --}}
    <x-script.delete-script route="{{ route('thekedar-prakar.destroy', '') }}"></x-script.delete-script>
@endsection
{{-- custom script ends --}}
