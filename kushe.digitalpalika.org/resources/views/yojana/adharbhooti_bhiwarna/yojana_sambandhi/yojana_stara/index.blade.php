...
@section('yojana-content')
    {{-- start card --}}
    <x-card.card :headers="['title' => 'योजना स्तर ', 'route' => route('yojana-stara.create')]">
        {{-- start table --}}
...
@section('custom-script')
    ...
    <x-script.datatable-script :options="[
        'route' => route('yojana-stara.index'),
    ...
    {{-- alert --}}
    <x-script.delete-script route="{{ route('yojana-stara.destroy', '') }}"></x-script.delete-script>
@endsection
{{-- custom script ends --}}
