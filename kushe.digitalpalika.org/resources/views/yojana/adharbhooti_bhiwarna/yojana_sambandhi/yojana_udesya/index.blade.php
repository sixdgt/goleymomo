...
@section('yojana-content')
    {{-- start card --}}
    <x-card.card :headers="['title' => 'याजनाका उदश्य', 'route' => route('yojana-udesya.create')]">
        {{-- start table --}}
...
@section('custom-script')
    ...
    <x-script.datatable-script :options="[
        'route' => route('yojana-udesya.index'),
    ...
    {{-- alert --}}
    <x-script.delete-script route="{{ route('yojana-udesya.destroy', '') }}"></x-script.delete-script>
@endsection
{{-- custom script ends --}}
