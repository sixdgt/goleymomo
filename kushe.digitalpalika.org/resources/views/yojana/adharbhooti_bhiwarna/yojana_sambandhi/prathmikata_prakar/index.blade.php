...
@section('yojana-content')
    {{-- start card --}}
    <x-card.card :headers="['title' => 'प्राथमिकताको प्रकार ', 'route' => route('prathmikata-prakar.create')]">
        {{-- start table --}}
...
@section('custom-script')
    ...
    <x-script.datatable-script :options="[
        'route' => route('prathmikata-prakar.index'),
    ...
    {{-- alert --}}
    <x-script.delete-script route="{{ route('prathmikata-prakar.destroy', '') }}"></x-script.delete-script>
@endsection
{{-- custom script ends --}}
