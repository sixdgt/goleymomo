...
<section id="chalani-add-form" class="chalani-add-form mt-2 container-fluid">
    <div class="card">
            <div class="card-header">
                ...
                <span class="card-title">नयाँ चलानी</span>
            </div>
            <form style="width: 100%;" id="add-form-chalani" method="POST" action="{{ route('chalani.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                ...
                <div class="row mt-2">
                    <div class="col">
                        <div class="form-group mb-2">
                            <label for="dp_chalani_letter_type" class="mb-2 form-label"><span class="asterik">*</span>पत्रको किसिम <a href="{{route('patra-kisim.index')}}" style="color: skyblue;"> (नयाँ पत्रको किसिम थप्नुहोस) </a></label>
                    ...
                    <div class="col">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" name="dp_chalani_letter_department" value="{{old('dp_chalani_letter_department')}}" id="applicant_name" aria-describedby="emailHelp" placeholder="पत्र बुज्ने शाखा">
                ...
                <div class="row mt-2">
                    <div class="col">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" name="dp_chalani_letter_to" value="{{old('dp_chalani_letter_to')}}" id="application_subject" aria-describedby="emailHelp" placeholder="पत्र पाउने कार्यालय वा व्यक्तिको नाम">
                        </div>
                    ...
                    <div class="col">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" name="dp_chalani_letter_address" value="{{old('dp_chalani_letter_address')}}" id="application_subject" aria-describedby="emailHelp" placeholder="पत्र पाउने कार्यालय वा व्यक्तिको ठेगाना">
                        </div>
                ...
                <div class="form-group mb-2 mt-2">
                    ...
                    <textarea class="ckeditor form-control" name="dp_chalani_subject">{{old('dp_chalani_subject')}}</textarea>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" name="dp_chalani_bodartha" value="{{old('dp_chalani_bodartha')}}" id="applicant_name" aria-describedby="emailHelp" placeholder="बोदार्थ">
                        </div>
                    ...
                    <div class="col">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" name="dp_chalani_kaifiyat" value="{{old('dp_chalani_kaifiyat')}}" id="applied_at" aria-describedby="emailHelp" placeholder="कैफियत">
                        </div>
