    ...
    <section id="darta-add-form" class="darta-add-form mt-2 mr-4">
                ...
                <div class="card">
                    <div class="card-header" style="">
                        ...
                        <span class='card-title'>नयाँ दर्ता</span>

                    </div>
                    <form style="width: 100%;" id="add-form-darta" method="POST" action="{{ route('darta.store') }}" enctype="multipart/form-data">
                        <div class="card-body">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        aria-describedby="emailHelp" placeholder="दर्ता नम्बर" value="{{ $darta_number + 1 }}" readonly>
                                    </div>
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        aria-describedby="emailHelp" placeholder="दर्ता मिती" value="{{ $date }}" readonly>
                                    </div>
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        aria-describedby="emailHelp" placeholder="चलानी नम्बर" value="{{ $chalani_number + 1 }}" readonly>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-lg-4">
                                    <div class="form-group mb-2">
                                        <label for="dp_darta_letter_department" class="mb-2 form-label"><span class="asterik">*</span>बर्तमान क्षेत्र तथा बिभागका साखाहरु <a href="{{route('sakha.index')}}" target="_blank" style="color: skyblue;"> (नयाँ साखा थप्नुहोस) </a></label>

                                        <select class="form-control" name="dp_darta_letter_department">
                                            <option value="">-- साखा छान्नुहोस् --</option>
                                            @foreach($sakhas as $sakha)
                                                    @if($sakha->id==old('dp_darta_letter_department'))
...
{{--                                            <option value="साखा 1">साखा 1</option>--}}
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    <div class="form-group mb-2">
                                        <label for="dp_darta_letter_to" class="mb-2 form-label"><span class="asterik">*</span>बर्तमान क्षेत्र तथा साखाका सदस्यहरु <a href="{{route('sadasya.index')}}" target="_blank" style="color: skyblue;"> (नयाँ सदस्य थप्नुहोस) </a></label>

                                        <select class="form-control" name="dp_darta_letter_to">
                                            <option value="">-- सदस्य छान्नुहोस् --</option>
                                            @foreach($sadasyas as $sadasya)

                                                @if($sadasya->id==old('dp_darta_letter_to'))
                                                    <option value="{{$sadasya->id}}" selected>{{$sadasya->name}}</option>
                                                @else
                                                    <option value="{{$sadasya->id}}" >{{$sadasya->name}}</option>
                                                @endif
                                            @endforeach
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" class="form-control" name="dp_darta_kaifiyat" value="{{old('dp_darta_kaifiyat')}}" id="dp_darta_kaifiyat" aria-describedby="emailHelp" placeholder="कैफियत">
                                    </div>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="dp_darta_subject" value="{{old('dp_darta_subject')}}" id="dp_darta_subject" aria-describedby="emailHelp" placeholder="बिषय">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <textarea class="form-control" name="dp_darta_description" id="dp_darta_description" rows="3">{{old('dp_darta_description')}}</textarea>
