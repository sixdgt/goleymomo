...
@section('content')
    ...
    <section class="mr-4 mt-2">
        <div class="card">
            ...
            <form action="{{ route('mahila.update',['id'=>$mahilaParichayapatra->id])}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    {{--            --}}
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-sm-12 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->first_name}}" name="first_name" placeholder="पहिलो नाम">
                                    <span class="text-danger">@error('first_name'){{ $message }}@enderror</span>
                                </div>

                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="middle_name" class="form-label"><b>बिचको नाम</b></label>
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->middle_name}}" name="middle_name" placeholder="बिचको नाम">
                                    <span class="text-danger">@error('middle_name'){{$message}}@enderror</span>
                                </div>

                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="last_name" class="form-label"><span class="asterik">*</span> <b> थर</b></label>
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->last_name}}" name="last_name" placeholder="थर">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->address_pradesh}}" name="address_pradesh" placeholder="प्रदेश">
                                ...
                                <div class="form-group col-sm-12 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->address_jilla}}" name="address_jilla" placeholder="जिल्ला">
                                ...
                                <div class="form-group col-sm-12 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->address_palika}}" name="address_palika" placeholder="स्थायी ठेगाना">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->address_ward_no}}" name="address_ward_no" placeholder="वडा नं">
                                ...
                                <div class="form-group col-sm-12 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->address_tol}}" name="address_tol" placeholder="टोल">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="first_name" class="form-label"><span class="asterik">*</span> <b>पहिलो नाम  </b></label>
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->father_first_name}}" name="father_first_name" placeholder="बुवाको पहिलो नाम ">
                                    <span class="text-danger">@error('father_first_name'){{ $message }}@enderror</span>
                                </div>

                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="middle_name" class="form-label"><b>बिचको नाम</b></label>
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->father_middle_name}}" name="father_middle_name" placeholder="बुवाको बिचको नाम">
                                    <span class="text-danger">@error('father_middle_name'){{$message}}@enderror</span>
                                </div>

                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="last_name" class="form-label"><span class="asterik">*</span> <b>थर</b></label>
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->father_last_name}}" name="father_last_name" placeholder="बुवाको थर">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="first_name" class="form-label"><span class="asterik">*</span> <b>पहिलो नाम  </b></label>
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->mother_first_name}}" name="mother_first_name" placeholder="आमाको पहिलो नाम ">
                                    <span class="text-danger">@error('mother_first_name'){{ $message }}@enderror</span>
                                </div>

                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="middle_name" class="form-label"><b>बिचको नाम</b></label>
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->mother_middle_name}}" name="mother_middle_name" placeholder="आमाको बिचको नाम">
                                    <span class="text-danger">@error('mother_middle_name'){{$message}}@enderror</span>
                                </div>

                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="last_name" class="form-label"><span class="asterik">*</span> <b>थर</b></label>
                                    <input type="text" class="form-control" value="{{$mahilaParichayapatra->mother_last_name}}" id="" name="mother_last_name" placeholder="आमाको थर">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="first_name" class="form-label"><span class="asterik">*</span> <b>पहिलो नाम  </b></label>
                                    <input type="text" class="form-control" value="{{$mahilaParichayapatra->grand_father_first_name}}" id="" name="grand_father_first_name" placeholder="बाजेको पहिलो नाम ">
                                    <span class="text-danger">@error('grand_father_first_name'){{ $message }}@enderror</span>
                                </div>

                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="middle_name" class="form-label"><b>बिचको नाम</b></label>
                                    <input type="text" class="form-control" value="{{$mahilaParichayapatra->grand_father_middle_name}}" id="" name="grand_father_middle_name" placeholder="बाजेको बिचको नाम">
                                    <span class="text-danger">@error('grand_father_middle_name'){{$message}}@enderror</span>
                                </div>

                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="last_name" class="form-label"><span class="asterik">*</span> <b>थर</b></label>
                                    <input type="text" class="form-control" value="{{$mahilaParichayapatra->grand_father_last_name}}" id="" name="grand_father_last_name" placeholder="बाजेको थर">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-sm-12 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->dob}}" name="dob" placeholder="जन्म मिति">
                                    <span class="text-danger">@error('dob'){{$message}}@enderror</span>
                                </div>

                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="contact" class="form-label"><span class="asterik">*</span> <b> मोबाइल नं</b></label>
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->contact}}" name="contact" placeholder="मोबाइल नं">
                                ...
                                <div class="form-group col-sm-12 col-lg-4">
                                    ...
                                    <select id="marital_status" name="marital_status" class="form-control">
                                        <option></option>
                                        <option value="विवाहीत" {{ ($mahilaParichayapatra->marital_status=="विवाहीत") ? "selected": ""}}>विवाहीत</option>
                                        <option value="अविवाहीत" {{ ($mahilaParichayapatra->marital_status=="अविवाहीत") ? "selected": ""}}>अविवाहीत</option>
                                        <option value="विधवा" {{ ($mahilaParichayapatra->marital_status=="विधवा") ? "selected": ""}}>विधवा</option>
                                    </select>
                    ...
                    {{-- पति--}}
                    <div class="card" id="pati_div" {{ ($mahilaParichayapatra->marital_status=="अविवाहीत") ? "hidden": ""}}>
                        <div class="card-body">
                            <label for="first_name" class="form-label"><span class="asterik">*</span> <b id="pati_label"> {{ ($mahilaParichayapatra->marital_status=="विवाहीत") ? "पतिको": " दिवंगत पतिको  "}}  </b></label>
                            {{--                    <label for="first_name" class="form-label"><span class="asterik">*</span> <b> दिवंगत पतिको  </b></label>--}}
                            <div class="row">
                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="first_name" class="form-label"><span class="asterik">*</span> <b>पहिलो नाम  </b></label>
                                    <input type="text" class="form-control" id=""  value="{{$mahilaParichayapatra->husband_first_name}}" name="husband_first_name" placeholder="पतिको पहिलो नाम ">
                                    <span class="text-danger">@error('husband_first_name'){{ $message }}@enderror</span>
                                </div>

                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="middle_name" class="form-label"><b>बिचको नाम</b></label>
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->husband_middle_name}}"  name="husband_middle_name" placeholder="पतिको बिचको नाम">
                                    <span class="text-danger">@error('husband_middle_name'){{$message}}@enderror</span>
                                </div>

                                <div class="form-group col-sm-12 col-lg-4">
                                    <label for="last_name" class="form-label"><span class="asterik">*</span> <b>थर</b></label>
                                    <input type="text" class="form-control" id="" value="{{$mahilaParichayapatra->husband_last_name}}"  name="husband_last_name" placeholder="पतिको थर">
