...
<section class="mr-4 mt-2">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('baalbaalika.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    {{--            --}}
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-sm-12 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="baalbaalika_dob" value="{{old('dob')}}" name="dob" placeholder="जन्म मिति">
                                ...
                                <div class="form-group col-sm-12 col-lg-4">
                                    ...
                                    <select name="gender" id="gender" class="form-control">
                                        <option></option>
                                        <option value="पुरुष" {{old('gender')=='पुरुष' ? "selected":""}}>पुरुष</option>
                                        <option value="महिला" {{old('gender')=='महिला' ? "selected":""}}>महिला</option>
                                        <option value="तेश्रो लिङ्गी" {{old('gender')=='तेश्रो लिङ्गी' ? "selected":""}}>तेश्रो लिङ्गी</option>
                                    </select>
