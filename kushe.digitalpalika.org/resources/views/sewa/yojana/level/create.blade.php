...
@section('title')
डिजिटल पालिका | योजनाको स्थर सेटिङ
@endsection
...
<section id="level-add-form" class="level-add-form">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                <span class=>योजनाको स्थरको विवरन समाबेश गर्नुहोस्</span>
                    ...
                    <div class="row mb-2">
                        <div class="col">
                            <div class="form-group mb-2">
                                <label for="level">योजनाको स्थरको नाम</label>
                                <input type="text" name="level" placeholder="योजनाको स्थरको नाम भर्नुहोस">
                            </div>
                        </div>
                    </div>
                </div>
