...
<section class="container-fluid">
    <div class="card">
        <h5 class="text-center">बिषयगत क्षेत्र</h5> 
        <div class="card-header d-flex flex-row-reverse bd-highlight">
            <a href="{{ route('subjective-area.create') }}" class="btn btn-sm btn-primary ml-2 bd-highlight" id="add-new"><i class="fas fa-plus-square"></i> बिषयगत क्षेत्र थप गर्नुहोस</a>
        </div>
        <div class="card-body">
            <table class="table table-bordered data-table">
                <thead>
                    <tr>
                        <th>बिषयगत क्षेत्र नो</th>
