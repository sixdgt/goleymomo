...
<div class="yojana_navbar">
    ...
    <div class="subnav">
      ...
      <div class="subnav-content">
        <a href="subjective-subarea-type.create">नयाँ थप गर्नुहोस</a>
        <a href="subjective-subarea-type.index">बिषयगत उप-क्षेत्र प्रकार</a>
      </div>
    </div>
    <div class="subnav">
...
<section class="container-fluid">
  <div class="row">
    <div class="col-md 12">
      <div class="card">
          <h5 class="text-center">बिषयगत उप-क्षेत्र</h5> 
          <div class="card-header d-flex flex-row-reverse bd-highlight">
              <a href="subjective-sub-area.create" class="btn btn-sm btn-primary ml-2 bd-highlight btns" id="add-new"><i class="fas fa-plus-square"></i> बिषयगत उप-क्षेत्र थप गर्नुहोस</a>
          </div>
          <div class="card-body">
              <table class="table table-bordered data-table">
                  <thead>
                      <tr>
                          <th>बिषयगत उप-क्षेत्र नो</th>
                          <th>बिषयगत उप-क्षेत्रको नाम</th>
                          <th>कार्य</th>
                      </tr>
                  </thead>
                  <tbody>
