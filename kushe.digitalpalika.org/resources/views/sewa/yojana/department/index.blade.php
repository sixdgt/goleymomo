...
<section class="container-fluid">
    <div class="row">
        <div class="col-md-12">
        <div class="card">
        <h5 class="text-center">विभाग सेटिङ</h5> 
        <div class="card-header d-flex flex-row-reverse bd-highlight">
            <a href="{{ route('department.create') }}" class="btn btn-sm btn-primary ml-2 bd-highlight btns" id="add-new"><i class="fas fa-plus-square"></i>विभाग थप गर्नुहोस</a>
        </div>
        <div class="card-body">
