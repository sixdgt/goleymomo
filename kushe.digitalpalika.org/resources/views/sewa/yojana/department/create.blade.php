...
<section id="department-add-form" class="department-add-form">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                <span class=>विभागको विवरन समाबेश गर्नुहोस्</span>
                    ...
                    <div class="row mb-2">
                        <div class="col">
                            <div class="form-group mb-2">
                                <label for="plan_subjective_area">विभागको नाम</label>
                                <input type="text" name="plan_subjective_area" placeholder="विभागको नाम भर्नुहोस">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <a href="{{ route('department.index') }}" class="btn btn-sm btn-primary btns" id="btn-back"><i class="fas fa-backspace"></i> पछाडी</a>
                            </div>
