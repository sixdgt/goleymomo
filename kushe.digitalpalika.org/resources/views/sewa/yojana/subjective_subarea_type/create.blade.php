...
@section('title')
डिजिटल पालिका | बिषयगत उप-क्षेत्र प्रकार सेटिङ
@endsection
...
<section id="subjective-sub-areatype-add-form" class="subjective-sub-areatype-add-form">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                <span class=> बिषयगत उप-क्षेत्रको प्रकार विवरन समाबेश गर्नुहोस्</span>
                <span class="pull-right">
                </span>
                </div>
                <div class="card-body">
                    <form style="width: 100%;" id="add-form-subjective-sub-areatype">
                    @csrf
                    <div class="row mb-2">
                        <div class="col">
                            <div class="form-group mb-2">
                                <label for="plan_subjective_area"> बिषयगत उप-क्षेत्रको प्रकार नाम</label>
                                <input type="text" name="plan_subjective_area" placeholder=" बिषयगत उप-क्षेत्रको प्रकार नाम भर्नुहोस">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <a href="{{ route('subjective-subarea-type.index') }}" class="btn btn-sm btn-primary btns" id="btn-back"><i class="fas fa-backspace"></i> पछाडी</a>
