...
<section class="container-fluid">
    <div class="card">
        <h5 class="text-center">बिषयगत उप-क्षेत्र प्रकार</h5> 
        <div class="card-header d-flex flex-row-reverse bd-highlight">
            <a href="{{ route('subjective-subarea-type.create') }}" class="btn btn-sm btn-primary ml-2 bd-highlight" id="add-new"><i class="fas fa-plus-square"></i> बिषयगत उप-क्षेत्र प्रकार थप गर्नुहोस</a>
        </div>
        <div class="card-body">
            <table class="table table-bordered data-table">
                <thead>
                    <tr>
                        <th>बिषयगत उप-क्षेत्र प्रकार नो</th>
                        <th>बिषयगत उप-क्षेत्र प्रकारको नाम</th>
                        <th>कार्य</th>
                    </tr>
                </thead>
                <tbody>
