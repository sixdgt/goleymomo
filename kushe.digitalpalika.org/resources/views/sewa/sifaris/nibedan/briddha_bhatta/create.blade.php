    ...
    <form action="{{ route('briddha-bhatta.store') }}" method="post">
        ...
        <div class="container-fluid border border-dark py-2"
                        ...
                        <div class="col-md-12">
                            <div class="row my-5">
                                <div class="col-md-8 ">
                                    ...
                                    @enderror
                                    <br>
                                    <input type='text' name="from_palika" style="width: 147px"
                                        placeholder=" भूमे गाउँपालिका" class="text-left">
                                    @error('from_palika')
                                        <p class="text-danger my-1">{{ $message }}</p>
                                    @enderror
                                    <input type='text' name="to_palika" style="width: 147px" placeholder="  गाउँपालिका "
                                        class="text-left">
                                    को कार्यालय
                                    @error('to_palika')
                                        <p class="text-danger my-1">{{ $message }}</p>
                                ...
                                <div class="col-md-4 py-1">
                                    <input class="float-end" name="application_date" type="date" name="" id="">
                                    <p class="float-end">
                                        मिति:
                                    </p>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            नाम, थर: <input type="text" name="name" id="">
                                            @error('name')
                                                <p class="text-danger my-1">{{ $message }}</p>
                                            @enderror
                                            <br><br>
                                            बाबुको नाम: <input type="text" name="father_name" id="">
                                            @error('father_name')
                                                <p class="text-danger my-1">{{ $message }}</p>
                                            @enderror
                                            <br><br>
                                            ठेगाना: <input type="text" name="address" id="">
                                            @error('address')
                                                <p class="text-danger my-1">{{ $message }}</p>
                                            @enderror
                                            <br><br>
                                            ना.प्र.नं.: <input type="text" name="citizenship_number" id="">
                                            @error('citizenship_number')
                                                <p class="text-danger my-1">{{ $message }}</p>
                                            @enderror
                                            <br><br>
                                            जेस नागरिकको हकमा उमेर परेको मिती:<input type="date"
                                                name="date_of_old_age_citizen" id="">
                                            @error('date_of_old_age_citizen')
                                                <p class="text-danger my-1">{{ $message }}</p>
                                            @enderror
                                            <br><br>
                                            पतिको मृत्यु दर्ता नम्बर : <input type="text" name="widow_spouse_name" id="">
                                            @error('widow_spouse_name')
                                                <p class="text-danger my-1">{{ $message }}</p>
                                            @enderror
                                            <br><br>
                                            दस्तखत: <input type="text" name="signature" id="">
                                            @error('signature')
                                                <p class="text-danger my-1">{{ $message }}</p>
                                            @enderror
                                            <br><br>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @enderror
                                            <br><br>
                                            आमाको नाम: <input type="text" name="mother_name" id="">
                                            @error('mother_name')
                                                <p class="text-danger my-1">{{ $message }}</p>
                                            @enderror
                                            <br><br>
                                            जन्ममिति: <input type="date" name="date_of_birth" id="">
                                            @error('date_of_birth')
                                                <p class="text-danger my-1">{{ $message }}</p>
                                            @enderror
                                            <br><br>
                                            जार जिल्ला: <input type="text" name="issued_district" id="">
                                            @error('issued_district')
                                                <p class="text-danger my-1">{{ $message }}</p>
                                            @enderror
                                            <br><br>
                                            सम्पर्क मोबाईल न: <input type="number" name="contact_number" id="">
                                            @error('contact_number')
                                                <p class="text-danger my-1">{{ $message }}</p>
                                            @enderror
                                            <br><br>
                                            पतिको मृत्यु मिति: <input type="date" name="window_spouse_death_date" id="">
            ...
            <div class="container border border-dark py-3">
                ...
                नाम दर्ता निर्णय मिति: <input type="date" name="registered_date" id="">
                @error('registered_date')
                    <p class="text-danger my-1">{{ $message }}</p>
                @enderror
                <br><br>

                भत्ताको किसिम: <input type="text" name="type" id="">
                @error('type')
                    <p class="text-danger my-1">{{ $message }}</p>
                @enderror
                <br><br>

                परिचय पत्र नं.: <input type="text" name="card_number" id="">
                @error('card_number')
                    <p class="text-danger my-1">{{ $message }}</p>
                @enderror
                <br><br>

                भत्ता पाउने सुरु मिति: आ.व. <input type="text" name="bhatta_started_date" id=""> को <select
                    name="month_type" id="">
            ...
            <p>निवेदकको विवरण</p>
            <div class="container border border-dark py-3">
                निवेदकको नाम:<br> <input type="text" name="applicant_name" id="">
                ...
                निवेदकको ठेगाना
                <br> <input type="text" name="applicant_address" id="">
                ...
                निवेटकको नागरिकता न.
                <br>
                <input type="text" name="applicant_citizenship_no" id="">
                ...
                निवेदकको फोन नं.
                <input type="text" name="applicant_contact" id="">
