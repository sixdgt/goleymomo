...
@section('title')
डिजिटल पालिका | ठेगाना प्रमाणिकरण सिफारिस
@endsection
...
<div class="main">
    <div class="d-flex justify-content-between">
        <div class="nagarik-heading">
            <p><a href="{{route('sifaris.index')}}"><i class="fas fa-arrow-left arrow"></i></a>ठेगाना प्रमाणिकरण सिफारिस</p>
        </div>
        <div class="pt-2">
            ...
            <form action="" method="post">
                ...
                @csrf
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="" name="address_prove_name" placeholder="व्यक्तिको नाम">
                    <span class="text-danger">@error('address_prove_name'){{$message}}@enderror</span>
                  </div>

                  <div class="mb-3">
                    <label for="text" class="form-label"><b>ठेगाना/Addressh</b></label>
                    <input type="text" class="form-control" id="" name="address_prove_addressh" placeholder="ठेगाना">
                    <span class="text-danger">@error('address_prove_addressh'){{$message}}@enderror</span>
                  </div>

                  <div class="mb-3">
                    <label for="text" class="form-label"><b>सिफारिसको प्रकार/Sifaris Type</b></label>
                    <input type="text" class="form-control" id="" name="address_prove_sifaris_type" placeholder="सिफारिसको प्रकार">
                    <span class="text-danger">@error('address_prove_sifaris_type'){{$message}}@enderror</span>
                  </div>

                  <div class="mb-3">
                    <label for="text" class="form-label"><b>सम्पर्क नम्बर/Contatc Number</b></label>
                    <input type="text" class="form-control" id="" name="address_prove_contact" placeholder="सम्पर्क नम्बर">
                    <span class="text-danger">@error('address_prove_contact'){{$message}}@enderror</span>
                  </div>

                  <div class="mb-3">
                    <label for="text" class="form-label"><b>विवरण</b></label>
                    <textarea class="ckeditor form-control" name="address_prove_dec"></textarea>
                    <span class="text-danger">@error('address_prove_dec'){{$message}}@enderror</span>
                  </div>
