    ...
    <table class="page_table" id="bipanna_nagarik_nibedan_table" border="1">
        <thead>
        <tr>
            <th>क्र.स.</th>
            <th>क्षेत्रफल </th>
    ...
    <tr>
        ...
        <td colspan="4">
            ...
            <div class='btn' id="bipanna_nagarik_nibedan_table_add_row"><i class="fas fa-plus-square"></i></div>
