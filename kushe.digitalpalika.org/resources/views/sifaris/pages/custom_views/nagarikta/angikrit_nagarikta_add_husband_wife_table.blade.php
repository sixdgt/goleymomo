...
<table class="page_table" id="angikrit_nagarikta_husband_wife_table" border="1">
    <thead>
    <tr>
        <th>क्र.स.</th>
        <th> नाम </th>
    ...
    @if(!isset($view_only))
        <tr>
            ...
            <td colspan="4">
                ...
                <div class='btn' id="angikrit_nagarikta_husband_wife_add_row"><i class="fas fa-plus-square"></i></div>
