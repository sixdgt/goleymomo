        ...
        <div class="card-body">
            <form action="{{route($view_array['form_store_url'])}}" method="post">
                ...
                <div class="card-header">
                    ...
                    <span class="card-title">{{$view_array['form_title']}}(नयाँ)</span>
                </div>
                    ...
                    <div class="row {{$section['div-class-name']}} div-nibedan">
                        ...
                        @if(array_key_exists('cols',$section['flex-div']))
                            @foreach($section['flex-div']['cols'] as $col)
                                <div class="col-lg-{{$col['col_no']}} col-sm-12">
                                        ...
                                        <div class="d-flex flex-wrap flex-nibedan justify-content-{{$section['flex-div']['position']}}">
                                            ...
                                            @foreach($row['fields'] as $field)
                                                ...
                                                @if($field['field_type']=='select')
                                                    <select id="{{$field['name']}}" class="input-text {{$field['class']}}" name="{{$field['name']}}">
                                                ...
                                                @endif
                                                    ...
                                                    @if($field['field_type']=='radio')
                                                        ...
                                                        @foreach($field['options'] as $key=>$option)
                                                            {{old($field['name'])}}
                                                            <input type="radio" id="radio{{$key}}" class="margin-left5" name="{{$field['name']}}" value="{{$key}}" {{ (old($field['name'])==$key && !old($field['name'])=="") ? "checked": ""}}>
                                                ...
                                                @endif
                                                    ...
                                                    @if($field['field_type']=='textarea')
                                                        ...
                                                        <textarea class="input-text {{(array_key_exists('class',$field) ? $field['class']:'')}}" id="{{$field['name']}}" name="{{$field['name']}}" type="textarea" placeholder="{{$field['placeholder']}}" value="{{old($field['name'])}}"></textarea>
                                                        <span class="text-danger " id="error_{{$field['name']}}">@error($field['name'])({{$message}})@enderror</span>
                                                    @endif
...
{{--                                            <span class="text-danger " id="error_{{$field['name']}}">@error($field['name'])({{$message}})@enderror</span>--}}
                ...
                <div class="row div-nibedank-detail div-nibedan">
                    <div class="d-flex flex-nibedan justify-content-center">
                        <button class="btn_palika" type="submit">सेभ गर्नुहोस</button>
                    </div>
                </div>
            </form>
        </div>
