...
@section('title')
डिजिटल पालिका | पासपोर्ट सिफारिस
@endsection
...
<div class="main">
    <div class="d-flex justify-content-between">
        <div class="nagarik-heading">
            <p><a href="{{route('sifaris.index')}}"><i class="fas fa-arrow-left arrow"></i></a>पासपोर्ट सिफारिस</p>
        </div>
        <div class="pt-2">
    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('passport.create')}}" method="post">

                @csrf
                  <div class="mb-3">
                    <label for="text" class="form-label"><b>व्यक्तिको नाम/Person Name</b></label>
                    <input type="text" class="form-control" id="" name="passport_name" placeholder="व्यक्तिको नाम">
                    <span class="text-danger">@error('passport_name'){{$message}}@enderror</span>
                  </div>

                  <div class="mb-3">
                    <label for="text" class="form-label"><b>विवरण/Description</b></label>
                    <textarea class="ckeditor form-control" name="passport_dec"></textarea>
                    {{-- <input type="text" class="form-control" id="" name="passport_dec" placeholder="ठेगाना"> --}}
                    <span class="text-danger">@error('passport_dec'){{$message}}@enderror</span>
                  </div>

                  <div class="mb-3">
                    <label for="text" class="form-label"><b>ठेगाना/Addressh</b></label>
                    <input type="text" class="form-control" id="" name="passport_addressh" placeholder="ठेगाना">
                    <span class="text-danger">@error('passport_addressh'){{$message}}@enderror</span>
                  </div>

                  <div class="mb-3">
                    <label for="text" class="form-label"><b>सिफारिसको प्रकार/Sifaris Type</b></label>
                    <input type="text" class="form-control" id="" name="passport_sifaris_type" placeholder="सिफारिसको प्रकार">
                    <span class="text-danger">@error('passport_sifaris_type'){{$message}}@enderror</span>
                  </div>

                  <div class="mb-3">
                    <label for="text" class="form-label"><b>सम्पर्क नम्बर/Contatc Number</b></label>
                    <input type="text" class="form-control" id="" name="passport_contact" placeholder="सम्पर्क नम्बर">
                    <span class="text-danger">@error('passport_contact'){{$message}}@enderror</span>
                  </div>
