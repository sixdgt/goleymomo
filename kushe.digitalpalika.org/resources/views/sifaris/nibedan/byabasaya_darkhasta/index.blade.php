...
@section('content')
    ...
    <section id="aadibasi-pramanit-content" class="mt-2">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('sifaris.index') }}" style="float:left;"><i class="fas fa-arrow-left arrow"></i></a>
                <span class="card-title">व्यवसाय दर्ता गर्ने दरखास्त</span>


                <a href="{{ route('byabasaya-darkhasta.create') }}" style="float:right;" class="btn_palika" id="add-new"><i class="fas fa-plus-square"></i> नयाँ</a>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('byabasaya-darkhasta.index') }}",
                    type: 'GET',
                    data: function(d) {
            ...
            $(document).on('click', '.delete-nibedan', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: "delete",
                            url: "{{ route('byabasaya-darkhasta.destroy', '') }}" + "/" + id,
                            data: data,
