    ...
    <section id="aadibasi-pramanit-content" class="mt-2">
        <div class="card">
            <div class="card-header">
                ...
                <span class="card-title">आदिबासी प्रमाणित सिफारिस</span>


                <a href="{{ route('aadibasi-pramanit.create') }}" style="float:right;" class="btn_palika" id="add-new"><i class="fas fa-plus-square"></i> नयाँ</a>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('aadibasi-pramanit.index') }}",
                    type: 'GET',
                    data: function(d) {
            ...
            $(document).on('click', '.delete-nibedan', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: "delete",
                            url: "{{ route('aadibasi-pramanit.destroy', '') }}" + "/" + id,
                            data: data,
