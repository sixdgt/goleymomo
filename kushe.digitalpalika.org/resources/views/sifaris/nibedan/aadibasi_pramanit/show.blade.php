...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('aadibasi-pramanit.index') }}" style="float: left"><i class="fas fa-arrow-left arrow"></i></a>
            <p><b class="card-title">आदिबासी प्रमाणित सिफारिस</b></p>
        ...
        <div class="card-body">
            <div class="row show-page-btns" style="">
                ...
                <div class="col-md-8 d-flex justify-content-between ">
                    ...
                    <a href="{{route('aadibasi-pramanit.edit',$model->id)}}" type="button" class="btn btn-outline-primary"><i class="fas fa-edit"></i> एडित गर्नुहोस</a>
                    ...
                    <a href="{{route('aadibasi-pramanit.index')}}" type="button" class="btn btn-outline-primary"><i class="fas fa-arrow-left"></i> पछाडी</a>
                </div>
                <div class="col-md-2"> </div>
            </div>
            <div class="row">
...
@section('custom-script')
    <script>
        ...
        $(document).ready(function () {
            $('.div-default-view').load("{{route('aadibasi-pramanit.default',$model->id)}}",function () {

            });
            load_pdf('div-pdf-view','{{route("aadibasi-pramanit.pdf",['id'=>$model->id])}}');
        });
        ...
        $('#btn-pdf').click(function () {
            ...
            load_pdf('div-pdf-view','{{route("aadibasi-pramanit.pdf",['id'=>$model->id])}}');
            {{--$('.div-pdf-view').html(--}}
            {{--    '<iframe src="' + '{{route("aadibasi-pramanit.pdf",['id'=>$model->id])}}' + '" style="margin:auto;width: 100%; height: 148mm">\n' +--}}
            {{--    '                        \n' +--}}
            {{--    '</iframe>'--}}
            {{--)--}}
