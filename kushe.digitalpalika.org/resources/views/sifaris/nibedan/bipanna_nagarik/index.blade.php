    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                ...
                <span class="card-title">विपन्न नागरिक आवेदन तथा सिफारिस</span>
                <a class="btn_palika float-end" href="{{ route('bipanna-nagarik.create') }}">
            ...
            <div class="card-body">
                ...
                <div style="margin-top: 15px">
                    <table class="table bipanna-nagarik-data-table">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>सिफारिस मिती</th>
    ...
    <script>
        ...
        function getData() {
            $(function() {
                ...
                var table = $('.bipanna-nagarik-data-table').DataTable({
                    clear: true,
                    destroy: true,
                    processing: true,
                    serverSide: true,
                    ...
                    ajax: {
                        url: "{{ route('bipanna-nagarik.index') }}",
                        type: 'GET',
                        data: function(d) {
                    ...
                    columns: [
                        ...
                        {
                            data: 'sifaris_garne_date',
                            name: 'sifaris_garne_date'
                        },
                        {
                ...
                $(document).on('click', '.delete-nibedan', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: "delete",
                                url: "{{ route('bipanna-nagarik.destroy', '') }}" + "/" + id,
                                data: data,
