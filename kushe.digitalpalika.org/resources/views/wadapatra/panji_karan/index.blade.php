...
@section('content')
    ...
    <div class="d-flex justify-content-between p-2">
        <div class="nagarik-heading">
            <p><a href="{{ route('wada-patra.index') }}"><i class="fas fa-arrow-left arrow"></i></a>पञ्जीकरण</p>
        </div>
        <div>
                    ...
                    <div class="modal-body" style="overflow: hidden;">
                        <form action="#" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="" name="dp_panjikaran_category" placeholder="Title">
                                <span class="text-danger">@error('dp_panjikaran_category'){{$message}}@enderror</span>
                              </div>
                              <div class="mb-3">
                                <label for="text" class="form-label" placeholder="description" value="description" placeholder="Title"><b>विवरण/Description</b></label>
                                <textarea class="form-control" placeholder="Describe yourself here..." id=""name="dp_panjikaran_category_dec" rows="3"></textarea>
                                <span class="text-danger">@error('dp_panjikaran_category_dec'){{$message}}@enderror</span>
                              </div>
    ...
    {{-- tabs --}}
    <div class="tab">
        <button class="tablinks" onclick="openGhar(event, 'tadid')">Add</button>
    </div>
    <div id="tadid" class="gharjaggacontent ">
        <div class="d-flex justify-content-between container-fluid p-2 active">
            <div class="heading"><h6>adsadasd</h6></div>
            <div class="sub-btn">
                <a href="#"><button data-toggle="modal" data-target="#ghar_sub_edit">Edit</button></a>
                <a href="#"><button data-toggle="modal">delete</button></a>
            </div>
        </div>
        <div class="ghar-content">
            <p class="container-fluid p-2 content">asdfasf</p>
        </div>
    </div>
</div>
    <!-- ModalEdit -->
