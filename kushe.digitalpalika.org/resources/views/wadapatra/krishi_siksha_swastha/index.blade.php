...
@section('title')
डिजिटल पालिका | कृषि/शिक्षा/स्वास्थ
@endsection
...
@section('content')
    ...
    <div class="d-flex justify-content-between p-2">
        <div class="nagarik-heading">
            <p><a href="{{ route('wada-patra.index') }}"><i class="fas fa-arrow-left arrow"></i></a>कृषि/शिक्षा/स्वास्थ</p>
        </div>
        <div>
                    ...
                    <div class="modal-body" style="overflow: hidden;">
                        <form action="#" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="" name="dp_education_category" placeholder="Title">
                                <span class="text-danger">@error('dp_education_category'){{$message}}@enderror</span>
                              </div>


                              <div class="mb-3">
                                <label for="text" class="form-label" placeholder="description" value="description" placeholder="Title"><b>विवरण/Description</b></label>
                                <textarea class="form-control" placeholder="Describe yourself here..." id=""name="dp_education_dec" rows="3"></textarea>
                                <span class="text-danger">@error('dp_education_dec'){{$message}}@enderror</span>
                              </div>
    ...
    {{-- tabs --}}
    <div class="tab">
         <button class="tablinks" onclick="openGhar(event, 'tabid')">asdasd</button>
    </div>
    ...
    {{-- tabs-contents --}}
        ...
        <div id="tabid" class="gharjaggacontent ">
            <div class="d-flex justify-content-between container-fluid p-2 active">
                ...
                <div class="heading"><h6>asdasd</h6></div>
